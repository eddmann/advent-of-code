...
func nextStep(sketch: Sketch, location: Location) -> Location {
    ...
    if (nextValue == "7" && location.direction == .RIGHT) { return nextLocation.with(direction: .DOWN) }
    if (nextValue == "F" && location.direction == .UP) { return nextLocation.with(direction: .RIGHT) }
    if (nextValue == "F" && location.direction == .LEFT) { return nextLocation.with(direction: .DOWN) }
    if (nextValue == "L" && location.direction == .LEFT) { return nextLocation.with(direction: .UP) }
    if (nextValue == "L" && location.direction == .DOWN) { return nextLocation.with(direction: .RIGHT) }
    if (nextValue == "J" && location.direction == .DOWN) { return nextLocation.with(direction: .LEFT) }
