...
Suddenly, the GPU contacts you, asking for _help_. Someone has asked it to simulate _too many particles_, and it won't be able to finish them all in time to render the next frame at this rate.
