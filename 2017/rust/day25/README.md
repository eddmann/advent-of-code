...
Following the twisty passageways deeper and deeper into the CPU, you finally reach the _core_ of the computer. Here, in the expansive central chamber, you find a grand apparatus that fills the entire room, suspended nanometers above your head.
