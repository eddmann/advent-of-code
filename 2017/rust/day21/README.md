...
You find a program trying to generate some art. It uses a strange process that involves _repeatedly enhancing_ the detail of an image through a set of rules.
