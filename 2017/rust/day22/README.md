...
Diagnostics indicate that the local _grid computing cluster_ has been contaminated with the _Sporifica Virus_. The grid computing cluster is a seemingly-_infinite_ two-dimensional grid of compute nodes. Each node is either _clean_ or _infected_ by the virus.
